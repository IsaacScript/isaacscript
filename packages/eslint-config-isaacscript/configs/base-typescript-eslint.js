...
const config = {
  ...
  rules: {
     ...
     * begin with an underscore, since this matches the behavior of the `--noUnusedLocals`
    ...
    /**
     * Disabled because this rule is deprecated. (It was renamed to
     ...
     * the `noImplicitAny` and `strictPropertyInitialization` TypeScript compiler options instead.)
     */
