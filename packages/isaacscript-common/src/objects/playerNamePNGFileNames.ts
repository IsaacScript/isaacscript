...
export const PLAYER_NAME_PNG_FILE_NAMES: {
  ...
  [PlayerType.THE_LOST]: "playername_12_thelost.png", // 10
  ...
  [PlayerType.THE_FORGOTTEN]: "playername_16_theforgotten.png", // 16
  // The Soul the same name as The Forgotten.
  [PlayerType.THE_SOUL]: "playername_16_theforgotten.png", // 17
  ...
  [PlayerType.THE_LOST_B]: "playername_12_thelost.png", // 31
  ...
  [PlayerType.THE_FORGOTTEN_B]: "playername_16_theforgotten.png", // 35
  ...
  [PlayerType.THE_SOUL_B]: "playername_16_theforgotten.png", // 40
} as const;
