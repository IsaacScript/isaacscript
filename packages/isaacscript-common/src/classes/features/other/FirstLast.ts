 ...
 *
 * The "FirstLast" feature gates all such functions behind a callback check. Subsequently, these
 * functions will throw a runtime error if they are called in the menu, before any callbacks have
 * occurred. This ensures that the proper values are always returned and allows you to get immediate
 * feedback if you accidentally access access them from the menu.
 */
export class FirstLast extends Feature {
