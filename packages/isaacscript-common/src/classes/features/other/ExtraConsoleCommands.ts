 ...
 * [dedicated command
 * list](/isaacscript-common/classes/features/other/extraconsolecommands/commands/) for more
...
export class ExtraConsoleCommands extends Feature {
   ...
   * commands](/isaacscript-common/classes/features/other/extraconsolecommands/commands/) that are
   * useful for debugging, but you can also add your own commands that are useful for your
   ...
   * The standard library comes with [many existing console
   * commands](/isaacscript-common/classes/features/other/extraconsolecommands/commands/) that are
   * useful for debugging. If you want to disable one of them, use this function.
   *
   * This function is intended to be called when your mod is first loading.
   *
   * In order to use this function, you must upgrade your mod with
   ...
   * The standard library comes with [many existing console
   * commands](/isaacscript-common/classes/features/other/extraconsolecommands/commands/) that are
   * useful for debugging. If you want to disable all of them after this feature has already been
   * initialized, use this function.
   *
   * In order to use this function, you must upgrade your mod with
   * `ISCFeature.EXTRA_CONSOLE_COMMANDS`.
   *
