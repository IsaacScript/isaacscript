...
export const ACTIVE_SLOT_VALUES: readonly ActiveSlot[] = getEnumValues(
  ActiveSlot,
);
...
export const DOOR_SLOT_FLAG_VALUES: readonly DoorSlotFlag[] = getEnumValues(
  DoorSlotFlag,
);

export const DOOR_SLOT_VALUES: readonly DoorSlot[] = getEnumValues(DoorSlot);

export const GRID_ENTITY_TYPE_VALUES: readonly GridEntityType[] = getEnumValues(
  GridEntityType,
);
...
export const ITEM_CONFIG_TAG_VALUES: readonly ItemConfigTag[] = getEnumValues(
  ItemConfigTag,
);
...
export const ITEM_POOL_TYPE_VALUES: readonly ItemPoolType[] = getEnumValues(
  ItemPoolType,
);

export const KEYBOARD_VALUES: readonly Keyboard[] = getEnumValues(Keyboard);

export const HEALTH_TYPE_VALUES: readonly HealthType[] = getEnumValues(
  HealthType,
);

export const PILL_COLOR_VALUES: readonly PillColor[] = getEnumValues(PillColor);

export const PLAYER_FORM_VALUES: readonly PlayerForm[] = getEnumValues(
  PlayerForm,
);

export const POCKET_ITEM_SLOT_VALUES: readonly PocketItemSlot[] = getEnumValues(
  PocketItemSlot,
);
...
export const SOUND_EFFECT_VALUES: readonly SoundEffect[] = getEnumValues(
  SoundEffect,
);

export const PLAYER_STAT_VALUES: readonly PlayerStat[] = getEnumValues(
  PlayerStat,
);

export const TRINKET_SLOT_VALUES: readonly TrinketSlot[] = getEnumValues(
  TrinketSlot,
);
