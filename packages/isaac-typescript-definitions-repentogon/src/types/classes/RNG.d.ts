declare interface RNG extends IsaacAPIClass {
   ...
   */
  readonly PhantomInt: ((max: int) => int) & ((min: int, max: int) => int);
   ...
   */
  readonly RandomIntEx: ((max: int) => int) & ((min: int, max: int) => int);
