...
declare global {
  ...
  interface LevelGeneratorRoom extends IsaacAPIClass {
    ...
    readonly DoorMask: () => BitFlags<DoorSlotFlag>;

    /**
     * Returns the order in which the room was generated (zero-based index). For example, a value of
     * 2 means it was the third room generated.
     */
    readonly GenerationIndex: () => int;
