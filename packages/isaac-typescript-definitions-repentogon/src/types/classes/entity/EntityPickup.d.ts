import type { CollectiblePedestalType, CollectibleType } from "isaac-typescript-definitions";
...
declare global {
    interface EntityPickup extends Entity {
        ...
        /**
         * Returns an array of all of the collectibles being used in the pickup's collectible cycle,
         * if it is a pedestal.
         */
         ...
         * pickups that are normally blind without curses involved, such as the extra item in the
         * alt path treasure rooms.
         */
        IsBlind: () => boolean;
        ...
        /**
         * Hides the collectible on the pedestal similarly to Curse of the Blind. Does nothing if
         * the pickup is not a collectible.
         */
         ...
         * 
         * Returns true if successful. Returns false if flipping the collectible failed or the
         * pickup is not a pedestal.
         */
        TryFlip: () => boolean;
         ...
         *
         * Returns true if the collectible was successfully removed. Returns false if the pedestal
         * is already empty or the pickup is not a collectible.
         */
    ...
    namespace EntityPickup {
         ...
         */
        function GetRandomPickupVelocity(position: Vector, rng: RNG, velocityType: int): Vector; 
    }
}