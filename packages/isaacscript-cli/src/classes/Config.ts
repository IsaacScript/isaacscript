...
export class Config {
  ...
  readonly modsDirectory?: string = String.raw`C:\Program Files (x86)\Steam\steamapps\common\The Binding of Isaac Rebirth\mods`;

  /** The save slot that you test your mod on. */
  readonly saveSlot?: number = 1;
   ...
   */
  readonly customTargetModDirectoryName?: string;
   ...
   */
  readonly isaacScriptCommonDev?: boolean = false;
