...
declare global {
  ...
  interface Mod {
     ...
     * ```
     */
    readonly AddCallback: <T extends keyof AddCallbackParameters | string>(
      modCallback: T,
     ...
     */
    readonly RemoveCallback: <T extends keyof AddCallbackParameters>(
      modCallback: T,
     ...
     */
    readonly SaveData: (data: string) => void;
