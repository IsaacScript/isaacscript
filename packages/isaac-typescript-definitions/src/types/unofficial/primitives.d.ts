 ...
 * it).
 */
// We intersect with an empty object to prevent VS Code from replacing `float` with `number` on
// mouseover.
 ...
 * it).
 */
// We intersect with an empty object to prevent VS Code from replacing `int` with `number` on
// mouseover.
// eslint-disable-next-line @typescript-eslint/naming-convention
