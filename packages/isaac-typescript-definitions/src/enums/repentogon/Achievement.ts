...
export enum Achievement {
  ...
  SMELTER = 318,
  APOLLYON_BABY = 319,
  UNLOCKED_A_NEW_AREA = 320,
  THE_VOID = 320,
  VOID_FLOOR = 320,
  ONCE_MORE_WITH_FEELING = 321,
  GULP_PILL = 321,
  HAT_TRICK = 322,
  ACE_OF_CLUBS = 322,
  ...
  SIN_COLLECTOR = 324,
  FEELS_LIKE_IM_WALKING_ON_SUNSHINE = 324,
  SUNSHINE_PILL = 324,
  DEDICATION = 325,
  HORF = 325,
  ZIP = 326,
  ...
  RERUNS = 337,
  DELIRIOUS = 338,
  ONE_MILLION_PERCENT_JUST_STOP = 339,
  ONE_MILLION_PERCENT = 339,
  JUST_STOP = 339,
  THE_DESTROYER = 340,
  APOLLYON = 340,
  GREEDIER = 341,
  ...
  BETHANY = 404,
  JACOB_AND_ESAU = 405,
  THE_STARS_ARE_CALLING = 406,
  PLANETARIUMS = 406,
  UNLOCKED_A_SECRET_EXIT = 407,
  SECRET_EXIT = 407,
  ALT_PATH = 407,
  ANTIBIRTH_PATH = 407,
  ...
  TAINTED_LAZARUS = 482,
  TAINTED_EDEN = 483,
  TAINTED_THE_LOST = 484,
  TAINTED_LOST = 484,
  TAINTED_LILITH = 485,
  TAINTED_KEEPER = 486,
  TAINTED_APOLLYON = 487,
  TAINTED_THE_FORGOTTEN = 488,
