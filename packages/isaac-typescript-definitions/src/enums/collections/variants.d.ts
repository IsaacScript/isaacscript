...
export declare enum PlayerVariant {
    PLAYER = 0,
    COOP_BABY = 1
}
/** For EntityType.TEAR (2) */
export declare enum TearVariant {
    BLUE = 0,
    BLOOD = 1,
    TOOTH = 2,
    METALLIC = 3,
...
export declare enum FamiliarVariant {
    FAMILIAR_NULL = 0,
    BROTHER_BOBBY = 1,
    DEMON_BABY = 2,
    LITTLE_CHUBBY = 3,
...
export declare enum BombVariant {
    NORMAL = 0,
    /** Mr. Boom bombs. */
    BIG = 1,
...
export declare enum PickupVariant {
    NULL = 0,
    HEART = 10,
    COIN = 20,
    KEY = 30,
...
export declare enum SlotVariant {
    SLOT_MACHINE = 1,
...
export declare enum LaserVariant {
    /** Used for Brimstone. */
    THICK_RED = 1,
    /** Used for Technology. */
    THIN_RED = 2,
...
export declare enum KnifeVariant {
    MOMS_KNIFE = 8,
    BONE_CLUB = 1,
    BONE_SCYTHE = 2,
    DONKEY_JAWBONE = 3,
...
export declare enum ProjectileVariant {
    NORMAL = 0,
    BONE = 1,
    FIRE = 2,
    PUKE = 3,
...
export declare enum GaperVariant {
    FROWNING_GAPER = 0,
    GAPER = 1,
    FLAMING_GAPER = 2,
    ROTTEN_GAPER = 3
...
export declare enum GusherVariant {
    GUSHER = 0,
    PACER = 1
}
/** For EntityType.POOTER (14) */
export declare enum PooterVariant {
    POOTER = 0,
    SUPER_POOTER = 1,
    TAINTED_POOTER = 2
}
/** For EntityType.CLOTTY (15) */
export declare enum ClottyVariant {
    CLOTTY = 0,
    CLOT = 1,
    BLOB = 2,
    GRILLED_CLOTTY = 3
...
export declare enum MulliganVariant {
    MULLIGAN = 16,
    MULLIGOON = 1,
    MULLIBOOM = 2
}
/** For EntityType.SHOPKEEPER (17) */
export declare enum ShopkeeperVariant {
    SHOPKEEPER = 0,
...
export declare enum LarryJrVariant {
    LARRY_JR = 0,
    THE_HOLLOW = 1,
    TUFF_TWIN = 2,
    THE_SHELL = 3
...
export declare enum HiveVariant {
    HIVE = 0,
    DROWNED_HIVE = 1,
    HOLY_MULLIGAN = 2,
    TAINTED_MULLIGAN = 3
...
export declare enum ChargerVariant {
    CHARGER = 0,
    DROWNED_CHARGER = 1,
    DANK_CHARGER = 2,
    CARRION_PRINCESS = 3
...
export declare enum GlobinVariant {
    GLOBIN = 0,
    GAZING_GLOBIN = 1,
    DANK_GLOBIN = 2,
    CURSED_GLOBIN = 3
...
export declare enum BoomFlyVariant {
    BOOM_FLY = 0,
    RED_BOOM_FLY = 1,
    DROWNED_BOOM_FLY = 2,
    DRAGON_FLY = 3,
...
export declare enum MawVariant {
    MAW = 0,
    RED_MAW = 1,
    PSYCHIC_MAW = 2
}
/** For EntityType.HOST (27) */
export declare enum HostVariant {
    HOST = 0,
    RED_HOST = 1,
    HARD_HOST = 2
}
/** For EntityType.CHUB (28) */
export declare enum ChubVariant {
    CHUB = 0,
    CHAD = 1,
    CARRION_QUEEN = 2
}
/** For EntityType.HOPPER (29) */
export declare enum HopperVariant {
    HOPPER = 0,
    TRITE = 1,
    EGGY = 2,
    TAINTED_HOPPER = 3
...
export declare enum BoilVariant {
    BOIL = 0,
    GUT = 1,
    SACK = 2
}
/** For EntityType.SPITTY (31) */
export declare enum SpittyVariant {
    SPITTY = 0,
    TAINTED_SPITTY = 1
}
/** For EntityType.FIREPLACE (33) */
export declare enum FireplaceVariant {
    NORMAL = 0,
    RED = 1,
    BLUE = 2,
    PURPLE = 3,
...
export declare enum LeaperVariant {
    LEAPER = 0,
    STICKY_LEAPER = 1
}
/** For EntityType.MR_MAW (35) */
export declare enum MrMawVariant {
    MR_MAW = 0,
    MR_MAW_HEAD = 1,
    MR_RED_MAW = 2,
    MR_RED_MAW_HEAD = 3,
...
export declare enum BabyVariant {
    BABY = 0,
    ANGELIC_BABY = 1,
    ULTRA_PRIDE_BABY = 2,
    WRINKLY_BABY = 3
...
export declare enum VisVariant {
    VIS = 0,
    DOUBLE_VIS = 1,
    CHUBBER = 2,
...
export declare enum GutsVariant {
    GUTS = 0,
    SCARRED_GUTS = 1,
    SLOG = 2
}
/** For EntityType.KNIGHT (41) */
export declare enum KnightVariant {
    KNIGHT = 0,
    SELFLESS_KNIGHT = 1,
    LOOSE_KNIGHT = 2,
    BRAINLESS_KNIGHT = 3,
...
export declare enum GrimaceVariant {
    STONE_GRIMACE = 0,
    VOMIT_GRIMACE = 1,
    TRIPLE_GRIMACE = 2
}
/** For EntityType.MONSTRO2 (43) */
export declare enum Monstro2Variant {
    MONSTRO_2 = 0,
    GISH = 1
}
/** For EntityType.POKY (44) */
export declare enum PokyVariant {
    POKY = 0,
    SLIDE = 1
}
/** For EntityType.MOM (45) */
export declare enum MomVariant {
    MOM = 0,
    STOMP = 10
}
/** For EntityType.SLOTH (46) */
export declare enum SlothVariant {
    SLOTH = 0,
    SUPER_SLOTH = 1,
    ULTRA_PRIDE = 2
}
/** For EntityType.LUST (47) */
export declare enum LustVariant {
    LUST = 0,
    SUPER_LUST = 1
}
/** For EntityType.WRATH (48) */
export declare enum WrathVariant {
    WRATH = 0,
    SUPER_WRATH = 1
}
/** For EntityType.GLUTTONY (49) */
export declare enum GluttonyVariant {
    GLUTTONY = 0,
    SUPER_GLUTTONY = 1
}
/** For EntityType.GREED (50) */
export declare enum GreedVariant {
    GREED = 0,
    SUPER_GREED = 1
}
/** For EntityType.ENVY (51) */
export declare enum EnvyVariant {
    ENVY = 0,
    SUPER_ENVY = 1,
    ENVY_BIG = 10,
    SUPER_ENVY_BIG = 11,
...
export declare enum PrideVariant {
    PRIDE = 0,
    SUPER_PRIDE = 1
}
/** For EntityType.DOPLE (53) */
export declare enum DopleVariant {
    DOPLE = 0,
    EVIL_TWIN = 1
}
/** For EntityType.LEECH (55) */
export declare enum LeechVariant {
    LEECH = 0,
    KAMIKAZE_LEECH = 1,
    HOLY_LEECH = 2
}
/** For EntityType.MEMBRAIN (57) */
export declare enum MemBrainVariant {
    MEMBRAIN = 0,
    MAMA_GUTS = 1,
    DEAD_MEAT = 2
}
/** For EntityType.PARA_BITE (58) */
export declare enum ParaBiteVariant {
    PARA_BITE = 0,
    SCARRED_PARA_BITE = 1
}
/** For EntityType.EYE (60) */
export declare enum EyeVariant {
    EYE = 0,
    BLOODSHOT_EYE = 1,
    HOLY_EYE = 2
}
/** For EntityType.SUCKER (61) */
export declare enum SuckerVariant {
    SUCKER = 0,
    SPIT = 1,
    SOUL_SUCKER = 2,
    INK = 3,
...
export declare enum PinVariant {
    PIN = 0,
    SCOLEX = 1,
    FRAIL = 2,
    WORMWOOD = 3
...
export declare enum WarVariant {
    WAR = 0,
    CONQUEST = 1,
    WAR_WITHOUT_HORSE = 2
}
/** For EntityType.DEATH (66) */
export declare enum DeathVariant {
    DEATH = 0,
    DEATH_SCYTHE = 10,
    DEATH_HORSE = 20,
...
export declare enum DukeVariant {
    DUKE_OF_FLIES = 0,
    THE_HUSK = 1
}
/** For EntityType.PEEP (68) */
export declare enum PeepVariant {
    PEEP = 0,
    BLOAT = 1,
    PEEP_EYE = 10,
    BLOAT_EYE = 11
...
export declare enum LokiVariant {
    LOKI = 0,
    LOKII = 1
}
/**
 ...
 */
export declare enum FistulaVariant {
    FISTULA = 0,
    TERATOMA = 1
}
/** For EntityType.MOMS_HEART (78) */
export declare enum MomsHeartVariant {
    MOMS_HEART = 0,
    IT_LIVES = 1,
    MOMS_GUTS = 2
}
/** For EntityType.GEMINI (79) */
export declare enum GeminiVariant {
    GEMINI = 0,
    STEVEN = 1,
    BLIGHTED_OVUM = 2,
    GEMINI_BABY = 10,
...
export declare enum FallenVariant {
    FALLEN = 0,
    KRAMPUS = 1
}
/** For EntityType.SATAN (84) */
export declare enum SatanVariant {
    SATAN = 0,
    STOMP = 10
}
/** For EntityType.GURGLE (87) */
export declare enum GurgleVariant {
    GURGLE = 0,
    CRACKLE = 1
}
/** For EntityType.WALKING_BOIL (88) */
export declare enum WalkingBoilVariant {
    WALKING_BOIL = 0,
    WALKING_GUT = 1,
    WALKING_SACK = 2
}
/** For EntityType.HEART (92) */
export declare enum HeartVariant {
    HEART = 0,
    HALF_HEART = 1
}
/** For EntityType.MASK (93) */
export declare enum MaskVariant {
    MASK = 0,
    MASK_2 = 1
}
/** For EntityType.WIDOW (100) */
export declare enum WidowVariant {
    WIDOW = 0,
    THE_WRETCHED = 1
}
/** For EntityType.DADDY_LONG_LEGS (101) */
export declare enum DaddyLongLegsVariant {
    DADDY_LONG_LEGS = 0,
    TRIACHNID = 1
}
/** For EntityType.ISAAC (102) */
export declare enum IsaacVariant {
    ISAAC = 0,
    BLUE_BABY = 1,
    BLUE_BABY_HUSH = 2
}
/** For EntityType.CONSTANT_STONE_SHOOTER (202) */
export declare enum ConstantStoneShooterVariant {
    CONSTANT_STONE_SHOOTER = 0,
    CROSS_STONE_SHOOTER = 10,
    CROSS_STONE_SHOOTER_ALWAYS_ON = 11
}
/** For EntityType.BABY_LONG_LEGS (206) */
export declare enum BabyLongLegsVariant {
    BABY_LONG_LEGS = 0,
    SMALL_BABY_LONG_LEGS = 1
}
/** For EntityType.CRAZY_LONG_LEGS (207) */
export declare enum CrazyLongLegsVariant {
    CRAZY_LONG_LEGS = 0,
    SMALL_CRAZY_LONG_LEGS = 1
}
/** For EntityType.FATTY (208) */
export declare enum FattyVariant {
    FATTY = 0,
    PALE_FATTY = 1,
    FLAMING_FATTY = 2
}
/** For EntityType.DEATHS_HEAD (212) */
export declare enum DeathsHeadVariant {
    DEATHS_HEAD = 0,
    /**
...
export declare enum SwingerVariant {
    SWINGER = 0,
    SWINGER_HEAD = 1,
    SWINGER_NECK = 2
}
/** For EntityType.DIP (217) */
export declare enum DipVariant {
    DIP = 0,
    CORN = 1,
    BROWNIE_CORN = 2,
    BIG_CORN = 3
...
export declare enum SquirtVariant {
    SQUIRT = 0,
    DANK_SQUIRT = 1
}
/** For EntityType.SKINNY (226) */
export declare enum SkinnyVariant {
    SKINNY = 0,
    ROTTY = 1,
    CRISPY = 2
}
/** For EntityType.BONY (227) */
export declare enum BonyVariant {
    BONY = 0,
    HOLY_BONY = 1
}
/** For EntityType.HOMUNCULUS (228) */
export declare enum HomunculusVariant {
    HOMUNCULUS = 0,
    HOMUNCULUS_CORD = 10
}
/** For EntityType.TUMOR (229) */
export declare enum TumorVariant {
    TUMOR = 0,
    PLANETOID = 1
}
/** For EntityType.NERVE_ENDING (231) */
export declare enum NerveEndingVariant {
    NERVE_ENDING = 0,
    NERVE_ENDING_2 = 1
}
/** For EntityType.GURGLING (237) */
export declare enum GurglingVariant {
    GURGLING = 0,
    GURGLING_BOSS = 1,
    TURDLING = 2
}
/** For EntityType.GRUB (239) */
export declare enum GrubVariant {
    GRUB = 0,
    CORPSE_EATER = 1,
    CARRION_RIDER = 2
}
/** For EntityType.WALL_CREEP (240) */
export declare enum WallCreepVariant {
    WALL_CREEP = 0,
    SOY_CREEP = 1,
    RAG_CREEP = 2,
    TAINTED_SOY_CREEP = 3
...
export declare enum RageCreepVariant {
    RAGE_CREEP = 0,
    SPLIT_RAGE_CREEP = 1
}
/** For EntityType.ROUND_WORM (244) */
export declare enum RoundWormVariant {
    ROUND_WORM = 0,
    TUBE_WORM = 1,
...
export declare enum PoopEntityVariant {
    NORMAL = 0,
    GOLDEN = 1,
    STONE = 11,
    CORNY = 12,
...
export declare enum StoneyVariant {
    STONEY = 0,
    CROSS_STONEY = 10
}
/** For EntityType.PORTAL (306) */
export declare enum PortalVariant {
    PORTAL = 0,
    LIL_PORTAL = 1
}
/** For EntityType.LEPER (310) */
export declare enum LeperVariant {
    LEPER = 0,
    LEPER_FLESH = 1
}
/** For EntityType.MR_MINE (311) */
export declare enum MrMineVariant {
    MR_MINE = 0,
    MR_MINE_NECK = 10
}
/** For EntityType.LITTLE_HORN (404) */
export declare enum LittleHornVariant {
    LITTLE_HORN = 0,
    DARK_BALL = 1
}
/** For EntityType.RAG_MAN (405) */
export declare enum RagManVariant {
    RAG_MAN = 0,
    RAG_MAN_HEAD = 1
}
/** For EntityType.ULTRA_GREED (406) */
export declare enum UltraGreedVariant {
    ULTRA_GREED = 0,
    ULTRA_GREEDIER = 1
}
/** For EntityType.RAG_MEGA (409) */
export declare enum RagMegaVariant {
    RAG_MEGA = 0,
    PURPLE_BALL = 1,
    REBIRTH_PILLAR = 2
}
/** For EntityType.BIG_HORN (411) */
export declare enum BigHornVariant {
    BIG_HORN = 0,
    SMALL_HOLE = 1,
    BIG_HOLE = 2
}
/** For EntityType.BLOOD_PUPPY (802) */
export declare enum BloodPuppyVariant {
    SMALL = 0,
    LARGE = 1
}
/** For EntityType.SUB_HORF (812) */
export declare enum SubHorfVariant {
    SUB_HORF = 0,
    TAINTED_SUB_HORF = 1
}
/** For EntityType.POLTY (816) */
export declare enum PoltyVariant {
    POLTY = 0,
    KINETI = 1
}
/** For EntityType.PREY (817) */
export declare enum PreyVariant {
    PREY = 0,
    MULLIGHOUL = 1
}
/** For EntityType.ROCK_SPIDER (818) */
export declare enum RockSpiderVariant {
    ROCK_SPIDER = 0,
    TINTED_ROCK_SPIDER = 1,
    COAL_SPIDER = 2
}
/** For EntityType.FLY_BOMB (819) */
export declare enum FlyBombVariant {
    FLY_BOMB = 0,
    ETERNAL_FLY_BOMB = 1
}
/** For EntityType.DANNY (820) */
export declare enum DannyVariant {
    DANNY = 0,
    COAL_BOY = 1
}
/** For EntityType.GYRO (824) */
export declare enum GyroVariant {
    GYRO = 0,
    GRILLED_GYRO = 1
}
/** For EntityType.FACELESS (827) */
export declare enum FacelessVariant {
    FACELESS = 0,
    TAINTED_FACELESS = 1
}
/** For EntityType.MOLE (829) */
export declare enum MoleVariant {
    MOLE = 0,
    TAINTED_MOLE = 1
}
/** For EntityType.BIG_BONY (830) */
export declare enum BigBonyVariant {
    BIG_BONY = 0,
    BIG_BONE = 10
}
/** For EntityType.GUTTED_FATTY (831) */
export declare enum GuttyFattyVariant {
    GUTTED_FATTY = 0,
    GUTTY_FATTY_EYE = 10,
    FESTERING_GUTS = 20
}
/** For EntityType.EXORCIST (832) */
export declare enum ExorcistVariant {
    EXORCIST = 0,
    FANATIC = 1
}
/** For EntityType.WHIPPER (834) */
export declare enum WhipperVariant {
    WHIPPER = 0,
    SNAPPER = 1,
    FLAGELLANT = 2
}
/** For EntityType.PEEPER_FATTY (835) */
export declare enum PeeperFattyVariant {
    PEEPING_FATTY = 0,
    PEEPING_FATTY_EYE = 10
}
/** For EntityType.REVENANT (841) */
export declare enum RevenantVariant {
    REVENANT = 0,
    QUAD_REVENANT = 1
}
/** For EntityType.CANARY (843) */
export declare enum CanaryVariant {
    CANARY = 0,
    FOREIGNER = 1
}
/** For EntityType.GAPER_L2 (850) */
export declare enum Gaper2Variant {
    GAPER = 0,
    HORF = 1,
    GUSHER = 2
}
/** For EntityType.CHARGER_L2 (855) */
export declare enum Charger2Variant {
    CHARGER = 0,
    ELLEECH = 1
}
/** For EntityType.EVIS (865) */
export declare enum EvisVariant {
    EVIS = 0,
    EVIS_GUTS = 10
}
/** For EntityType.DARK_ESAU (866) */
export declare enum DarkEsauVariant {
    DARK_ESAU = 0,
    PIT = 1
}
/** For EntityType.DUMP (876) */
export declare enum DumpVariant {
    DUMP = 0,
    DUMP_HEAD = 1
}
/** For EntityType.NEEDLE (881) */
export declare enum NeedleVariant {
    NEEDLE = 0,
    PASTY = 1
}
/** For EntityType.CULTIST (885) */
export declare enum CultistVariant {
    CULTIST = 0,
    BLOOD_CULTIST = 1,
    BONE_TRAP = 10
}
/** For EntityType.VIS_FATTY (886) */
export declare enum VisFattyVariant {
    VIS_FATTY = 0,
    FETAL_DEMON = 1
}
/** For EntityType.GOAT (891) */
export declare enum GoatVariant {
    GOAT = 0,
    BLACK_GOAT = 1
}
/** For EntityType.VISAGE (903) */
export declare enum VisageVariant {
    VISAGE = 0,
    VISAGE_MASK = 1,
    VISAGE_CHAIN = 10,
    VISAGE_PLASMA = 20
...
export declare enum SirenVariant {
    SIREN = 0,
    SIREN_SKULL = 1,
    SIREN_HELPER_PROJECTILE = 10
}
/** For EntityType.SCOURGE (909) */
export declare enum ScourgeVariant {
    SCOURGE = 0,
    SCOURGE_CHAIN = 10
}
/** For EntityType.CHIMERA (910) */
export declare enum ChimeraVariant {
    CHIMERA = 0,
    CHIMERA_BODY = 1,
    CHIMERA_HEAD = 2
}
/** For EntityType.ROTGUT (911) */
export declare enum RotgutVariant {
    PHASE_1_HEAD = 0,
    PHASE_2_MAGGOT = 1,
    PHASE_3_HEART = 2
}
/** For EntityType.MOTHER (912) */
export declare enum MotherVariant {
    /**
...
export declare enum SingeVariant {
    SINGE = 0,
    SINGE_BALL = 1
}
/** For EntityType.RAGLICH (919) */
export declare enum RaglichVariant {
    RAGLICH = 0,
    RAGLICH_ARM = 1
}
/** For EntityType.CLUTCH (921) */
export declare enum ClutchVariant {
    CLUTCH = 0,
    CLUTCH_ORBITAL = 1
}
/** For EntityType.DOGMA (950) */
export declare enum DogmaVariant {
    DOGMA_PHASE_1 = 0,
    TV = 1,
    ANGEL_PHASE_2 = 2,
...
export declare enum BeastVariant {
    BEAST = 0,
    STALACTITE = 1,
    ROCK_PROJECTILE = 2,
    SOUL = 3,
...
export declare enum GenericPropVariant {
    GENERIC_PROP = 0,
    MOMS_DRESSER = 1,
    MOMS_VANITY = 2,
    COUCH = 3,
