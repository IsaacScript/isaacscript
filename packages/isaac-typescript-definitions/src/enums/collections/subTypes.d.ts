...
export declare enum BabySubType {
    UNASSIGNED = -1,
    SPIDER = 0,
    LOVE = 1,
    BLOAT = 2,
...
export declare enum MotherSubType {
    PHASE_1 = 0,
    PHASE_2 = 1
}
/** For EntityType.EFFECT (1000), EffectVariant.BLOOD_EXPLOSION (2) */
export declare enum BloodExplosionSubType {
...
/** For EntityType.EFFECT (1000), EffectVariant.POOF01 (15) */
export declare enum PoofSubType {
    NORMAL = 0,
    SMALL = 1,
    LARGE = 3
}
/** For EntityType.EFFECT (1000), EffectVariant.HEAVEN_LIGHT_DOOR (39) */
export declare enum HeavenLightDoorSubType {
    HEAVEN_DOOR = 0,
    MOONLIGHT = 1
}
/** For EntityType.EFFECT (1000), EffectVariant.TALL_LADDER (156) */
export declare enum LadderSubType {
    TALL_LADDER = 0,
    STAIRWAY = 1
}
/** For EntityType.EFFECT (1000), EffectVariant.PURGATORY (189) */
export declare enum PurgatorySubType {
    RIFT = 0,
    GHOST = 1
}
