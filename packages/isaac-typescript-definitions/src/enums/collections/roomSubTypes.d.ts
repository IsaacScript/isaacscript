 ...
 */
export declare enum ShopSubType {
    LEVEL_1 = 0,
    LEVEL_2 = 1,
    LEVEL_3 = 2,
    LEVEL_4 = 3,
 ...
 */
export declare enum TreasureRoomSubType {
    NORMAL = 0,
    MORE_OPTIONS = 1,
    PAY_TO_WIN = 2,
 ...
 */
export declare enum MinibossID {
    SLOTH = 0,
    LUST = 1,
    WRATH = 2,
    GLUTTONY = 3,
 ...
 * This matches the sub-type in the "00.special rooms.stb" file.
 */
export declare enum CurseRoomSubType {
    NORMAL = 0,
    VOODOO_HEAD = 1
}
/**
 ...
 * This matches the sub-type in the "00.special rooms.stb" file and elsewhere.
 */
export declare enum ChallengeRoomSubType {
    NORMAL = 10,
    BOSS = 11,
    GREAT_GIDEON = 12
}
 ...
 * This matches the sub-type in the "00.special rooms.stb" file.
 */
export declare enum LibrarySubType {
    LEVEL_1 = 0,
    LEVEL_2 = 1,
    LEVEL_3 = 2,
    LEVEL_4 = 3,
 ...
 * This matches the sub-type in the "00.special rooms.stb" file.
 */
export declare enum DevilRoomSubType {
    NORMAL = 0,
 ...
 * This matches the sub-type in the "00.special rooms.stb" file.
 */
export declare enum AngelRoomSubType {
    NORMAL = 0,
 ...
 * This matches the sub-type in the "00.special rooms.stb" file and elsewhere.
 */
export declare enum DungeonSubType {
    NORMAL = 0,
 ...
 */
export declare enum IsaacsRoomSubType {
    NORMAL = 0,
    GENESIS = 99
}
/**
 ...
 * This matches the sub-type in the "00.special rooms.stb" file.
 */
export declare enum SecretExitSubType {
    DOWNPOUR = 1,
    MINES = 2,
    MAUSOLEUM = 3
}
 ...
 */
export declare enum DownpourRoomSubType {
    NORMAL = 0,
    WHITE_FIRE = 1,
    MIRROR = 34
}
 ...
 */
export declare enum MinesRoomSubType {
    NORMAL = 0,
    BUTTON_ROOM = 1,
 ...
 */
export declare enum HomeRoomSubType {
    ISAACS_BEDROOM = 0,
    HALLWAY = 1,
    MOMS_BEDROOM = 2,
    LIVING_ROOM = 3,
 ...
 */
export declare enum BackwardsRoomSubType {
    EXIT = 0,
    BASEMENT = 1,
    CAVES = 4,
    DEPTHS = 7,
