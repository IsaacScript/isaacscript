...
| [`isaacscript/require-capital-read-only`](docs/rules/require-capital-read-only.md)               | Requires maps/sets with a capital letter to be read-only                                              | :white_check_mark: |          | :thought_balloon: |
