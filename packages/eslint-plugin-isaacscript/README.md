...
| [`isaacscript/no-mutable-return`](docs/rules/no-mutable-return.md)                                       | Disallows returning mutable data structures from functions                                                  | :white_check_mark: |          | :thought_balloon: |
