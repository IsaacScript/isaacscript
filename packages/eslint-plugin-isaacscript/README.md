...
| [`isaacscript/no-mutable-array-return`](docs/rules/no-mutable-array-return.md)                           | Disallows returning mutable arrays from functions                                                           | :white_check_mark: |          | :thought_balloon: |
